...
SYSTEM_PROMPT = (
    ...
    "(3) Key complications (4) Evidence-based self-care/management "
    "(5) ‘When to seek care’. Professional tone. "
    "Do NOT ask the user questions unless essential. Include a brief disclaimer."
)

DISCLAIMER = (
    "⚠️ Disclaimer: This is general information, not a medical diagnosis or "
